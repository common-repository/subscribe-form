            ...
            <div>
                <table id="upc_subscriber_tab">
                    <tr>
                        ...
                        <td><a href="<?php echo plugins_url('sfbip_subscriber_list.php?download_file=sfbip_subcribers_list.csv',__FILE__); ?>" class="wpappp_buton" id="wpappp_export_to_csv" value="Export to CSV" href="#">Download & Export to CSV</a></td>
                        <td><strong>Delete All Subscibers from Database: </strong></td>
                        <td><input type="button" class="wpappp_buton" id="sfbip_delete_all_data" value="Delete All Data" /></td>
                    </tr>
                </table>
            </div>
            <div>
                    ...
                    <tr>
                        ...
                        foreach ( $result as $print )   {
                            ...
                            <tr>
                                ...
                                <td><input type="button" data-delete="<?php echo $print->id;?>" class="upc_delete_entry wpappp_buton sfbip_delete_entry" id="upc_delete_entry" value="Delete Record" style="margin:0 auto;display:block;"/>
                                </td>
                            </tr>
                            <?php }
                        }
